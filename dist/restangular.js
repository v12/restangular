 ...
 * @version v1.5.1 - 2015-05-22 * @link https://github.com/mgonto/restangular
      ...
      BaseCreator.prototype.resource =
        function (current, $http, localHttpConfig, callHeaders, callParams, what, etag, operation) {
          ...
          if (this.config.suffix &&
              url.indexOf(this.config.suffix, url.length - this.config.suffix.length) ===
              -1 &&
    ...
    this.$get = ['$http', '$q', function ($http, $q) {
      ...
      function createServiceForConfiguration (config) {
        ...
        function elemFunction (operation, what, params, obj, headers) {
          ...
          // fallback to etag on restangular object (since for custom methods we probably don't explicitly specify the
          // etag field)
          var etag = callObj[config.restangularFields.etag] ||
                     (operation !== 'post' ? this[config.restangularFields.etag] : null);
